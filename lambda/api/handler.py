...
def ask_document(document_id: str, body: dict[str, Any]) -> dict[str, Any]:
    ...
    try:
        ...
        answer_prompt = (
            ...
            "FORMATTING RULES:\n"
            "- Write in plain text only. Do NOT use markdown (no **, ##, -, or bullet syntax).\n"
            "- Keep the answer concise: 2-5 sentences for simple facts, up to a short paragraph for complex questions.\n"
            "- Mention the source briefly in parentheses, e.g. (from extracted data) or (page 42).\n"
            "- Do not repeat the question or add headings.\n\n"
            f"Question: {question}\n\n"
            f"{combined_context}\n"
            "Answer:"
        )
